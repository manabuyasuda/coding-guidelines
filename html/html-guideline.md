...
### 終了タグの省略をしない
ほとんどの人にとって読みにくくなってしまいます。一般的なルールで書きましょう。
...
### strongとemとbを適切に使う
strongとemとbタグは見た目や意味から混同しがちな要素です。「どれを使うか」だけでなく、「どれを使わないか」も決めておきましょう。
...
SEOに有効ですが、URLの指定を間違えてしまうと適切にインデックスされなくなってしまうので慎重に指定してください（自動化できるとなお良い）。
